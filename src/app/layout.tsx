...
export const metadata: Metadata = {
  title: "Aionysus Wine - AI Wine Sommelier",
  description: "Your divine AI guide to the world of wine. Discover, learn, and enjoy wines with Aionysus.",
};
